...
@Extension
abstract class WebNovelPub(private val deps: Dependencies) : SourceFactory(deps = deps) {
    ...
    private fun clientBuilder(): HeadersBuilder.() -> Unit = {
        append("site-domain", "www.webnovelpub.com")
    ...
    override suspend fun getChapterList(
        ...
        if (commands.isEmpty()) {
            ...
            for (page in 1..lastPage) {
                val html = client.get(requestBuilder(manga.key + "/chapters/page-$page")).asJsoup()
