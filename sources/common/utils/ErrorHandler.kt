...
object ErrorHandler {
    ...
    data class RetryConfig(
        ...
        val retryOnErrors: Set<Class<out Exception>> = setOf(
            SourceError.NetworkError::class.java,
            SourceError.RateLimitError::class.java
        )
    )
    ...
    suspend fun <T> withRetry(
        ...
        repeat(config.maxAttempts) { attempt ->
            try {
                ...
                val shouldRetry = config.retryOnErrors.any { it.isInstance(e) }
