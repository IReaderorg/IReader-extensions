...
@Extension
abstract class Mangadex(private val deps: Dependencies,private val httpClient: HttpClient): HttpSource(deps), DeepLinkSource {
  ...
  private fun clientBuilder(): OkHttpClient = httpClient.okhttp
    .newBuilder()
