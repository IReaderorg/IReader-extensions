...
import org.ireader.extensions.sources.en.mtlnovel.mtlSearchItem
...
@Extension
abstract class MtlNovel(deps: Dependencies,okHttpClient: OkHttpClient) : ParsedHttpSource(deps) {
