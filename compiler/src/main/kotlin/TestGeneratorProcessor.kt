    ...
    private fun generateIntegrationTests(source: KSClassDeclaration, config: GenerateTestsConfig) {
        ...
        testClassBuilder.addFunction(
            FunSpec.builder("testListings")
                ...
                .addStatement("%T(listings.isNotEmpty(), %S)", assertClass, "Source should have at least one listing")
        ...
        testClassBuilder.addFunction(
            FunSpec.builder("testFetchLatestNovels")
                ...
                .addStatement("    val listings = source.getListings()")
                .addStatement("    %T(listings.isNotEmpty(), %S)", assertClass, "Source should have listings")
                .addStatement("    ")
                .addStatement("    val result = source.getMangaList(listings.first(), 1)")
        ...
        testClassBuilder.addFunction(
            FunSpec.builder("testPagination")
                ...
                .addStatement("    val page1 = source.getMangaList(listings.first(), 1)")
                ...
                .addStatement("        val page2 = source.getMangaList(listings.first(), 2)")
        ...
        testClassBuilder.addFunction(
            FunSpec.builder("testFetchNovelDetailsComprehensive")
                ...
                .addStatement("%T {", runBlockingClass)
                .addStatement("    val listings = source.getListings()")
                .addStatement("    val novels = source.getMangaList(listings.first(), 1)")
        ...
        testClassBuilder.addFunction(
            FunSpec.builder("testEndToEndFlow")
                ...
                .addStatement("    val listings = source.getListings()")
                .addStatement("    val browseResult = source.getMangaList(listings.first(), 1)")
        ...
        FileSpec.builder(packageName, testClassName)
            ...
            .addImport("ireader.core.source.model", "Filter", "Text")
