...
class TestGeneratorProcessor(
    ...
    private fun generateTestHttpClients(): TypeSpec {
        ...
        val okHttpEngineClass = ClassName("io.ktor.client.engine.okhttp", "OkHttp")
        ...
        return TypeSpec.classBuilder("TestHttpClients")
            .addKdoc("Mock HttpClients for testing. Uses real Ktor HttpClient with OkHttp for network requests.\n")
            ...
            .addProperty(
                PropertySpec.builder("default", httpClientClass)
                    .addModifiers(KModifier.OVERRIDE)
                    .getter(FunSpec.getterBuilder()
                        .addStatement("return %T(%T)", httpClientClass, okHttpEngineClass)
                        .build())
                    .build()
            )
            .addProperty(
